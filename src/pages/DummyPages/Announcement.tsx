      ...
      <div className='main_layout'>
        ...
        <ul className='fold_list_layout'>
          <FoldListComponent title='새로운 기능 도착! 채팅으로 더 가까이 소통하세요! 🚀'>
            ...
            <br/>
            저희 SideMatch에 새로운 기능이 추가되었습니다! 이제부터 프로젝트에 참여한 다른 멤버들과 손쉽게 소통할 수 있는 <b>채팅 기능</b>이 도입되었습니다.<br/>
            ...
            <ol>
              ...
              <li><b>프로젝트 관련 대화:</b> 프로젝트에 관한 대화를 효율적으로 관리하세요.<br/></li>
            </ol>
          ...
          <FoldListComponent title='SideMatch에 오신걸 환영합니다'>
            ...
            <br/>
            우리는 팀을 만들고 함께 사이드 프로젝트를 통해 지식을 공유하고 쌓아갈 수 있는 새로운 플랫폼을 선보이게 되어 기쁩니다. <br/>
            <br/>
